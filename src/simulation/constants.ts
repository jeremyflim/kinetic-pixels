...
export const MINIMUM_ROOM_TEMPERATURE = -100
export const MAXIMUM_ROOM_TEMPERATURE = 500
...
export const HEAT_EMISSION_INTERVAL = 6
...
// Water keeps its real relative thermal mass, but phase completion is shortened for play.
export const WATER_BOILING_LATENT_SCALE = 0.18
